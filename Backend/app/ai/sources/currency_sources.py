...
class CurrencySources:
    """
    CurrencySources bertanggung jawab mengelola metadata dan akses data
    kurs mata uang asing untuk kebutuhan kalkulasi biaya (Prinsip 1, 11).
    """
    ...
    def get_active_currency_sources(self) -> list[Source]:
        """
        Mengambil semua data source finansial/kurs mata uang yang aktif.
        """
    ...
    def get_currency_fallback(self, source_currency: str, target_currency: str) -> dict[str, Any]:
        """
        Menyediakan data fallback struktur nilai tukar jika API eksternal RTO (Prinsip 10).
        """
